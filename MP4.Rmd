...
classdat %>%
  ggplot(aes(x=AR, y=ClCd, color=bird)) + geom_point() + geom_smooth(method = "lm", col="red") + theme_minimal() + ggtitle("Figure 1: Class Data of Aspect Ratio versus Lift Ratio") + 
